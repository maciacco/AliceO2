...
template <int N>
std::vector<o2::framework::OutputSpec> makeOutChannels(o2::header::DataOrigin detOrig, bool mctruth, bool doStag)
{
...
DataProcessorSpec getIOTOFDigitizerSpec(int channel, bool mctruth)
{
  ...
  inputs.emplace_back("collisioncontext", "SIM", "COLLISIONCONTEXT", static_cast<o2::framework::DataHeader::SubSpecificationType>(channel), o2::framework::Lifetime::Timeframe);
  ...
  return o2::framework::DataProcessorSpec{detStr + "Digitizer",
                                          inputs, makeOutChannels(o2::header::gDataOriginIOTOF, mctruth),
